...
<script type="text/javascript">
	$(document).ready(function(){
 	...
 	<body>
        ...
        <div class="logo-iavh">
                      <a href="http://www.humboldt.org.co" rel="home" title="IAVH Logo" class="active"><img src="${baseURL}/styles/iavh.png" />
                       </a>
                       </div>
        </div>
          ...
          <div class="grid_11 region region-branding" id="region-branding">
            <div class="region-inner region-branding-inner">
              <div class="branding-data clearfix">
                <div class="logo-img">
                  <a href="${baseURL}" rel="home" title="Ceiba Logo" class="active">
